...
public class HuffProcessor {
	...
	private void makeEncodings(HuffNode root, String current, String[] encodings) {
		if (root == null) {
			return;
		}
		if (root.left == null && root.right == null) {
			encodings[root.value] = current;
			return;
		}
		makeEncodings(root.left, current + "0", encodings);
		makeEncodings(root.right, current + "1", encodings);
	}
